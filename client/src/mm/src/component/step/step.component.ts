...
export class StepItemComponent{
  ...
  @ViewChild('contentView',{read:ViewContainerRef,static:true})contentChild:ViewContainerRef;
  @ViewChild('titleView',{read:ViewContainerRef,static:true})titleChild:ViewContainerRef;
  @Input()isEnd:boolean;
  @Input()deps:any;
  @Input()index:number;
