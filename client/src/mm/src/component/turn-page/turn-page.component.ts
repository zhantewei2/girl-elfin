...
export class TurnPageComponent implements OnInit {
  ...
  @ViewChild('primary',{static:true})primary:any;
  @ViewChild('secondary',{static:true})secondary:any;
  @ViewChild('thirdly',{static:true})thirdly:any;

  @ViewChild('pContainer',{read:ViewContainerRef,static:true})pContainer:ViewContainerRef;
  @ViewChild('sContainer',{read:ViewContainerRef,static:true})sContainer:ViewContainerRef;
  @ViewChild('tContainer',{read:ViewContainerRef,static:true})tContainer:ViewContainerRef;
