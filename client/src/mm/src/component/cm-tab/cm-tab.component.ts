...
export class CmTabComponent implements OnInit {
  ...
  @ViewChild('thumb',{static:true})thumb:any;
...
export class CmTabGroup{
  ...
  @ContentChild(CmTabComponent,{static:false})tabBar:CmTabComponent;
  @ContentChild(Cm2TurnComponent,{static:false})tabContent:Cm2TurnComponent;
