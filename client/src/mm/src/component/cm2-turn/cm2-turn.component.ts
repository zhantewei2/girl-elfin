...
export class Cm2TurnComponent implements OnInit {
  ...
  @ViewChild('_a',{read:ViewContainerRef,static:true})_a:ViewContainerRef;
  @ViewChild('_b',{read:ViewContainerRef,static:true})_b:ViewContainerRef;
  @ViewChild('_c',{read:ViewContainerRef,static:true})_c:ViewContainerRef;
